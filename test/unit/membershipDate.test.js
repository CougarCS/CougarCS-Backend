...
describe('Date Member Unit Test', () => {
    test('Test Jan 1: Semester', () => {
        const date = new Date(YEAR, 0, 1);
        const { membershipStart, membershipEnd } = getMembershipDates(SEMESTER_TERM, date);
    ...
    test('Test Jan 1: Year', () => {
        const date = new Date(YEAR, 0, 1);
        const { membershipStart, membershipEnd } = getMembershipDates(YEAR_TERM, date);
        expect(membershipStart.Term).toEqual(SPRING);
        expect(membershipStart.Year).toEqual(YEAR);
